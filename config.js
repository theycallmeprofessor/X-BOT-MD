...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:014b25b8f5b5d5bbce16fff8a68364b5";
const SUDO = process.env.SUDO || '923195045539';
...
const STICKER_DATA = process.env.STICKER_DATA || "X BOT ";
